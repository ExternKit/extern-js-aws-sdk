...
typedef _ShapeS29 = {
    ...
    @:optional var PendingModifiedValues : {
        ...
        @:optional var PendingCloudwatchLogsExports : {
            @:optional var LogTypesToEnable : _ShapeS1n;
            @:optional var LogTypesToDisable : _ShapeS1n;
        };
    ...
    @:optional var DBSecurityGroups : _ShapeS1g;
    @:optional var AllocatedStorage : Int;
    ...
    @:optional var BackupRetentionPeriod : Int;
    @:optional var ListenerEndpoint : _ShapeS2a;
    ...
    @:optional var Endpoint : _ShapeS2a;
